...
import {data} from '../../utils/data/progData'
function Prog() {
  ...
  return (
    <div className='flex lg:flex-row lg:justify-around lg:items-center flex-col items-center gap-y-6'>
        <div className='flex flex-col gap-y-7 px-10'>
          ...
          <button className='self-start px-6 py-3 bg-amber-300 rounded-md  text-black  text-base font-extrabold font-["Epilogue"] uppercase' onClick={() => openInNewTab('https://leetcode.com/sreejita12/')}>Leetcode Profile</button>
        </div>
        <div className='w-[400px] h-[360px] self-start'>
